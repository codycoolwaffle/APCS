...
public class Light
{
    ...
    {
        if(c.toLowerCase().equals("red") == true || c.toLowerCase().equals("blue") == true || c.toLowerCase().equals("green") == true || c.toLowerCase().equals("white") == true)
            color = c.toLowerCase();
        else
            color = "white";
    }
